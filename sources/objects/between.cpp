...
namespace strong
{
std::optional<std::string_view> between(std::string_view content, const std::string_view begin,
                                        const std::string_view end)
{
    ...
    return content.substr(begin_pos + begin.size(), end_pos - begin_pos - begin.size());
}
} // namespace strong
